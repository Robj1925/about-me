...
1. **The Weights:** Each button has a "weight." If the Brighten button has a high weight, pressing it makes the light jump to a higher number.
2. **The Bias:** You also have a starting point (we call this a bias). This is like the baseline brightness of the room before you touch the buttons.
3. **The ReLU Rule:** Here is the magic part! ReLU is a simple rule:
