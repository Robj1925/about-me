...
*   **The Number Game:** Every one of these chunks gets a special ID number. For example, "Hello" might become the number `15496`.
*   **Math Power:** Once everything is a number, the AI uses math to figure out which numbers usually hang out together. 
