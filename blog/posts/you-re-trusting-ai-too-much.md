...
1.  **Always double-check:** If the AI gives you a fact, look it up in a real, trusted source.
2.  **Don't use it for legal or medical advice:** AI can sound like a lawyer or a doctor, but it doesn't have a brain or a license!
3.  **Use it for help, not for truth:** Use AI to help you write code, brainstorm ideas, or summarize notes. Just don't let it be the final judge of what is true.
