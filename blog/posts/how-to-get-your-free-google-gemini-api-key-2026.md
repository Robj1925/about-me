...
1. **Visit Google AI Studio:** Head over to the [Google AI Studio website](https://aistudio.google.com/app/projects).
2. **Create a New Project:** If you haven’t yet, click the button to start a new project. This keeps your work organized.
3. **Get Your Key:** Look for the tab that says "Get API key." Click it, and you will see a button to create a key in a new or existing project.
4. **Copy and Save:** Once your key pops up, copy it immediately. You won't be able to see the full key again once you close that window!
